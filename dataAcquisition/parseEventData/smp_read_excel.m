...
%     .cols         - struct of detected column names for each standard field
    ...
    fprintf('  Cars: %d   Drivers: %d   Manufacturers: %d\n', ...
        numel(data.cars), numel(data.drivers), numel(data.manufacturers));
end
...
% Edit the patterns below to match your actual spreadsheet headers.
