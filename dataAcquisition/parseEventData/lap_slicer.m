...
%       .units / .sample_rate / .raw_name  (copied)
    ...
    if beacon_check
        ...
        beacon_check_plot(session, laps, br2_field_orig, lap_num_data, lap_num_time, beacon_label);
    end
end
...
% ======================================================================= %
function beacon_check_plot(session, laps, br2_field, lap_num_data, lap_num_time, label)
...
%                    lap type.
    ...
    if isempty(label)
        ...
        fig_title = sprintf('Beacon Check — %s', label);
    end
