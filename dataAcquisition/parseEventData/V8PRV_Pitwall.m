...
%     lbl.Layout.Row = 1;
    ...
    hStatusLbl = uilabel(LG, 'Text', 'No cache loaded', 'FontColor', [0.5 0.5 0.5], 'HorizontalAlignment', 'center', 'FontSize', 9);
    hStatusLbl.Layout.Row = 7;

    lbl = makeLabel22(LG, 'Text', 'SESSIONS (ctrl+click)', 'FontWeight', 'bold', 'FontSize', 9);
    lbl.Layout.Row = 8;

    hSessionsList = uilistbox(LG, 'Items', {}, 'Multiselect', 'on');
    hSessionsList.Layout.Row = 9;

    lbl = makeLabel22(LG, 'Text', 'TEAMS (ctrl+click)', 'FontWeight', 'bold', 'FontSize', 9);
    lbl.Layout.Row = 10;

    hTeamsList = uilistbox(LG, 'Items', {}, 'Multiselect', 'on');
    hTeamsList.Layout.Row = 11;

    lbl = makeLabel22(LG, 'Text', 'MANUFACTURERS (ctrl+click)', 'FontWeight', 'bold', 'FontSize', 9);
    lbl.Layout.Row = 12;

    hMfrList = uilistbox(LG, 'Items', {}, 'Multiselect', 'on');
    hMfrList.Layout.Row = 13;

    lbl = makeLabel22(LG, 'Text', 'LAP RANGE  (min / max)', 'FontWeight', 'bold', 'FontSize', 9);
    lbl.Layout.Row = 14;
    ...
    hFilterStatus = makeLabel22(LG, 'Text', '', ...
    ...
    cgr = uigridlayout(CG, [1 2]); cgr.Layout.Row = r; cgr.ColumnWidth = {130,'1x'}; cgr.Padding = [0 0 0 0]; cgr.RowSpacing = 0;
    lbl = makeLabel22(cgr, 'Text', 'Plot Type'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    cgr = uigridlayout(CG, [1 2]); cgr.Layout.Row = r; cgr.ColumnWidth = {130,'1x'}; cgr.Padding = [0 0 0 0]; cgr.RowSpacing = 0;
    lbl = makeLabel22(cgr, 'Text', 'Math Function'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    hMathFn = uidropdown(cgr, 'Items', MATH_FNS, 'Value', 'mean'); hMathFn.Layout.Row = 1; hMathFn.Layout.Column = 2;
    r = r + 1;

    cgr = uigridlayout(CG, [1 2]); cgr.Layout.Row = r; cgr.ColumnWidth = {130,'1x'}; cgr.Padding = [0 0 0 0]; cgr.RowSpacing = 0;
    lbl = makeLabel22(cgr, 'Text', 'X Axis'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    for yi = 1:4
        cgr = uigridlayout(CG, [1 2]); cgr.Layout.Row = r; cgr.ColumnWidth = {130,'1x'}; cgr.Padding = [0 0 0 0]; cgr.RowSpacing = 0;
        lbl = makeLabel22(cgr, 'Text', axLabels{yi}); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    cgr = uigridlayout(CG, [1 2]); cgr.Layout.Row = r; cgr.ColumnWidth = {130,'1x'}; cgr.Padding = [0 0 0 0]; cgr.RowSpacing = 0;
    lbl = makeLabel22(cgr, 'Text', 'Custom Expression', 'FontColor', [0.85 0.65 0.1]); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    hCustomExpr = uieditfield(cgr, 'text', 'Value', ''); hCustomExpr.Layout.Row = 1; hCustomExpr.Layout.Column = 2;
    r = r + 1;

    cgr = uigridlayout(CG, [1 2]); cgr.Layout.Row = r; cgr.ColumnWidth = {130,'1x'}; cgr.Padding = [0 0 0 0]; cgr.RowSpacing = 0;
    lbl = makeLabel22(cgr, 'Text', 'Colour Mode'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    cgr = uigridlayout(CG, [1 2]); cgr.Layout.Row = r; cgr.ColumnWidth = {130,'1x'}; cgr.Padding = [0 0 0 0]; cgr.RowSpacing = 0;
    lbl = makeLabel22(cgr, 'Text', 'Differentiator'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    cgr = uigridlayout(CG, [1 2]); cgr.Layout.Row = r; cgr.ColumnWidth = {130,'1x'}; cgr.Padding = [0 0 0 0]; cgr.RowSpacing = 0;
    lbl = makeLabel22(cgr, 'Text', 'Align Max Offset (s)'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    %% ---- TAB 4: Speed Trap ----
    tab4 = uitab(tabGrp, 'Title', 'Speed Trap');
    ...
    lbl = makeLabel2(t4r1, 'Text', 'Timing Dir'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    lbl = makeLabel2(t4r3, 'Text', 'Event'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    lbl = makeLabel2(t4r4, 'Text', 'Session'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    lbl = makeLabel2(t4r5, 'Text', 'Report Type'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
    ...
    %% ---- TAB 5: Tyre Radius ----
    tab5 = uitab(tabGrp, 'Title', 'Tyre Radius');
    ...
    tmp = makeLabel2(t5r1, 'Text', 'r0 (mm)');     tmp.Layout.Column = 1;
    hTrR0    = uieditfield(t5r1, 'numeric', 'Value', 28.2200);  hTrR0.Layout.Column    = 2;
    tmp = makeLabel2(t5r1, 'Text', 'P coef');       tmp.Layout.Column = 3;
    ...
    tmp = makeLabel2(t5r2, 'Text', 'Fz coef');      tmp.Layout.Column = 1;
    hTrFzCoef = uieditfield(t5r2, 'numeric', 'Value', -0.000340); hTrFzCoef.Layout.Column = 2;
    tmp = makeLabel2(t5r2, 'Text', 'N coef (RPM)'); tmp.Layout.Column = 3;
    ...
    tmp = makeLabel2(t5r3, 'Text', 'Total Mass (kg)');   tmp.Layout.Column = 1;
    hTrMass  = uieditfield(t5r3, 'numeric', 'Value', 1300); hTrMass.Layout.Column  = 2;
    tmp = makeLabel2(t5r3, 'Text', 'g Ref (vertical)');  tmp.Layout.Column = 3;
    ...
    tmp = makeLabel2(t5r4, 'Text', 'Front CL slope');  tmp.Layout.Column = 1;
    hTrFCLs = uieditfield(t5r4, 'numeric', 'Value', -0.002087248); hTrFCLs.Layout.Column = 2;
    tmp = makeLabel2(t5r4, 'Text', 'Front CL intcpt'); tmp.Layout.Column = 3;
    ...
    tmp = makeLabel2(t5r5, 'Text', 'Rear CL slope');  tmp.Layout.Column = 1;
    hTrRCLs = uieditfield(t5r5, 'numeric', 'Value', -0.000202926); hTrRCLs.Layout.Column = 2;
    tmp = makeLabel2(t5r5, 'Text', 'Rear CL intcpt'); tmp.Layout.Column = 3;
    ...
    tmp = makeLabel2(t5r6, 'Text', 'Event');   tmp.Layout.Column = 1;
    hTrEvent   = uieditfield(t5r6, 'text', 'Value', '');  hTrEvent.Layout.Column   = 2;
    tmp = makeLabel2(t5r6, 'Text', 'Session'); tmp.Layout.Column = 3;
    hTrSession = uieditfield(t5r6, 'text', 'Value', '');  hTrSession.Layout.Column = 4;

    % Row 7: spacer
    tmp = makeLabel2(T5G, 'Text', ''); tmp.Layout.Row = 7;
    ...
    lbl = makeLabel2(t2r1, 'Text', 'Excel File'); lbl.Layout.Row = 1; lbl.Layout.Column = 1;
...
%% =========================================================================
%  HELPER: label — uilabel is supported since R2018b
%% =========================================================================
function h = makeLabel22(parent, varargin)
    h = uilabel(parent, varargin{:});
end
%% =========================================================================
%  HELPER: label — uilabel is supported since R2018b
%% =========================================================================
function h = makeLabel2(parent, varargin)
    h = uilabel(parent, varargin{:});
end
...
function onPlotDirect(fig)
    ...
    try
        ...
        if ~isempty(srcFig)
            ...
            if ~isempty(allAx)
                n = numel(allAx);
                % uiaxes has no Units property -- InnerPosition is always
                % in pixels, so the normalized fractions below must be
                % scaled by the panel's current pixel size before use.
                panelSz = h.plotPnl.InnerPosition;
                pw = panelSz(3);
                ph = panelSz(4);
                for ai = 1:n
                    srcAx = allAx(ai);
                    ...
                    newAx.Position = [pos(1)*pw, pos(2)*ph, pos(3)*pw, pos(4)*ph];
