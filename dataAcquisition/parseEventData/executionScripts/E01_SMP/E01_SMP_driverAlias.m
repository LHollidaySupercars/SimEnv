...
% clear opts
opts.date_from        = datetime(2026, 2, 20);   % auto-filled: earliest session date for this event/track

opts.alias_file       = fullfile(pwd, 'dataAcquisition/Motec_MP/alias/driverAlias.xlsx');
opts.event_alias_file = fullfile(pwd, 'dataAcquisition\parseEventData\executionScripts\E01_SMP/eventAlias.xlsx');
opts.xref_export      = fullfile(pwd, 'dataAcquisition/parseEventData/aliasReports/SMP_alias_check.xlsx');
% opts.verbose          = false;
result = smp_discover_aliases('E:\2026/E01_SMP/_TeamData', opts);
...
%
% Usage:
%   debug_print_session_field('E:\2026\E01_SMP\_TeamData\01_T8R\<file>.ld')
