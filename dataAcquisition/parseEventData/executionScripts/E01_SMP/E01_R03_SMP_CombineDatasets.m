...
SESSION   = 'R03';   % session to process (used in all phases)
...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E01_R03', 'E01_SMP_Constants.xlsx');
...
cfg.event_date   = '2026-02-22';   % auto-filled from sessionDate.xlsx (this session's date) — used by Phase 1 (TeamData date filter) and Phase 4b (L180 sort)
