...
SESSION   = 'Q02';   % session to process (used in all phases)
...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E01_Q02', 'E01_SMP_Constants.xlsx');
CHANNELS_FILE          = fullfile( pwd, 'dataAcquisition\Motec_MP\channels\channels.xlsx');

% =========================================================================
%  EVENT CONFIG  — edit when setting up a new event
% =========================================================================
cfg.root_folder  = 'E:\2026\E01_SMP';   % event root — all paths derived from here
cfg.hol_venue    = 'Sydney Motorsport Park';
cfg.hol_event    = 'E01_SMP';
cfg.event_date   = '2026-02-21';   % auto-filled from sessionDate.xlsx (this session's date) — used by Phase 1 (TeamData date filter) and Phase 4b (L180 sort)
