...
SESSION   = 'R02';   % session to process (used in all phases)
...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E01_R02', 'E01_SMP_Constants.xlsx');
