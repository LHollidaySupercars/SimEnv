...
cfg.date_from        = datetime(2026, 2, 21);   % auto-filled from sessionDate.xlsx (this session's date)
...
writetable(pit_summary, fullfile(saveLocation, '26VCS_PitStop_SMP_E01_Q02.xlsx'))
