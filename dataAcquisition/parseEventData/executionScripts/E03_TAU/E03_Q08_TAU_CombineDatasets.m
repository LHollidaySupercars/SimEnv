...
SESSION   = 'Q08';   % session to process (used in all phases)
...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E03_Q08', 'E03_TAU_Constants.xlsx');
