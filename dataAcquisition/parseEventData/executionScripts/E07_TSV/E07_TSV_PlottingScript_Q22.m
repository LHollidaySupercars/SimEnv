...
% =========================================================================
cfg.root_folder      = 'E:\2026\E07_TSV\COM';
cfg.channels_file    = 'C:/SimEnv/dataAcquisition/Motec_MP/channels/channels.xlsx';
cfg.event_alias_file = 'C:\SimEnv\dataAcquisition\parseEventData\executionScripts\E07_TSV\eventAlias.xlsx';
...
cfg.plot_config_files= {'C:\SimEnv\dataAcquisition\Motec_MP\plottingRequest\E07_TSV\PR_E07TSV_plotRequest.xlsx',...
                        ...
                        'C:\SimEnv\dataAcquisition\Motec_MP\plottingRequest\E07_TSV\SR_E07TSV_plotRequest.xlsx'};
cfg.season_file      = 'C:/SimEnv/trackDB/seasonOverview.xlsx';
cfg.pptx_template    = 'C:/SimEnv/dataAcquisition/Motec_MP/plot/templates/SuperCars_PPT.pptx';
cfg.output_dir       = 'C:/SimEnv/dataAcquisition/Motec_MP/plot/output/E07_TSV';
cfg.date_from        = datetime(2026, 6, 19);
% cfg.plot_config_files= {'C:\SimEnv\dataAcquisition\Motec_MP\plottingRequest\E07_TSV\PR_E07TSV_plotRequest.xlsx',...
%     'C:\SimEnv\dataAcquisition\Motec_MP\plottingRequest\E07_TSV\AR_E07TSV_plotRequest.xlsx'};
...
%   partial caches for a parallel compile pass.
    ...
    cache = smp_cache_load(cfg.root_folder, cfg.session_filter);
...
% SMP_TYRE_CHANGES_FROM_CACHE  Infer tyre changes from cache by comparing
%   tyre wheel-sensor ID lap-to-lap. Only considers laps > 5.
%   Requires driver_map in scope for car number lookup.
    ...
    for g = 1:numel(group_keys)
        ...
        for i = 1:(n_laps - 1)
            ...
            rows{end+1} = {drv, car, lap_next, changed(1), changed(2), changed(3), changed(4), n_ch}; %#ok<AGROW>
        end
    end
...
function car = resolve_car_number(drv, driver_map)
% RESOLVE_CAR_NUMBER  Look up car number for a driver label via driver_map,
%   trying direct key, normalised key, then alias match.
    car = '';
