...
cfg.date_from        = datetime(2026, 7, 11);   % auto-filled from sessionDate.xlsx (this session's date)
...
writetable(pit_summary, fullfile(saveLocation, '26VCS_PitStop_TSV_E07_R21.xlsx'))
