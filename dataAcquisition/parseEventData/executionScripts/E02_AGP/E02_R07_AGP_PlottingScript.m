...
cfg.date_from        = datetime(2026, 3, 8);   % auto-filled from sessionDate.xlsx (this session's date)
...
writetable(pit_summary, fullfile(saveLocation, '26VCS_PitStop_AGP_E02_R07.xlsx'))
