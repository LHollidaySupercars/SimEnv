...
SESSION   = 'R04';   % session to process (used in all phases)
...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E02_R04', 'E02_AGP_Constants.xlsx');
