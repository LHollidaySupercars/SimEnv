...
SESSION   = 'Q22';   % session to process (used in all phases)
...
cfg.event_date   = '2026-07-12';         % used by Phase 1 (TeamData date filter) and Phase 4b (L180 sort)
...
Car     = [31, 2, 17, 1, 31, 6, 17, 19, 1, 26, 3, 38, 55, 7, 6, 2, 17, 19,1, 20, 99, 19, 18,26, 8, 31, 2, 55, 88, 1, 17, 6, 19, 88, 1, 6, 19, 17];
FrontRH = [97, 78, 91,   82, 97, 86, 87, 95, 76, 100, 107, 90, 88, 104, 84, 77, 90, 99, 81, 92, 93, 95, 95, 99 ,113 ,95 ,77 ,88 ,90 ,77 ,87 ,86 ,98 ,113 ,83 ,88 ,95 ,84];
RearRH  = [142, 158, 135, 136, 141, 132, 135, 144, 141, 145, 136, 135, 131, 141, 133, 139, 134, 147,135, 139, 141, 143, 144 ,142 ,126 ,142 ,138 ,129 ,126 ,136 ,136 ,134 ,144 ,126 ,137 ,132 ,142 ,131];
Session = {'Q20','Q20','Q20','R20','R20','R20','R20','R20','Q21','Q21','Q21','Q21','Q21','Q21','Q21','Q21','Q21','Q21','R21','R21','R21','R21','R21', 'Q22' ,'Q22' ,'Q22' ,'Q22' ,'Q22' ,'Q22' ,'Q22' ,'Q22' ,'Q22' ,'Q22' ,'R22' ,'R22' ,'R22' ,'R22' ,'R22'};
length(Car)
length(FrontRH)
length(RearRH)
