...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E02_P02', 'E02_AGP_Constants.xlsx');
CHANNELS_FILE          = fullfile( pwd, 'dataAcquisition\Motec_MP\channels\channels.xlsx');

% =========================================================================
%  EVENT CONFIG  — edit when setting up a new event
% =========================================================================
cfg.root_folder  = 'E:\2026\E02_AGP';   % event root — all paths derived from here
cfg.hol_venue    = 'Sydney Motorsport Park';
cfg.hol_event    = 'E02_AGP';
cfg.event_date   = '2026-03-05';   % auto-filled from sessionDate.xlsx (this session's date) — used by Phase 1 (TeamData date filter) and Phase 4b (L180 sort)
