...
cfg.event_alias_file = fullfile(pwd,'dataAcquisition\parseEventData\executionScripts\E07_TSV\eventAlias.xlsx');
cfg.driver_alias_file= fullfile(pwd,'dataAcquisition/Motec_MP/alias/driverAlias.xlsx');
cfg.plot_config_files= {fullfile(pwd,'dataAcquisition\Motec_MP\plottingRequest\E07_TSV\PR_E07TSV_plotRequest.xlsx'),...
                        fullfile(pwd,'dataAcquisition\Motec_MP\plottingRequest\E07_TSV\AR_E07TSV_plotRequest.xlsx'),...
                        fullfile(pwd,'dataAcquisition\Motec_MP\plottingRequest\E07_TSV\SR_E07TSV_plotRequest.xlsx')};
...
cfg.output_dir       = fullfile(pwd,'dataAcquisition/Motec_MP/plot/output/E07_TSV');
