...
% clear opts
opts.date_from        = datetime(2026, 6, 19);   % auto-filled: earliest session date for this event/track

opts.alias_file       = fullfile(pwd, 'dataAcquisition/Motec_MP/alias/driverAlias.xlsx');
opts.event_alias_file = fullfile(pwd, 'dataAcquisition\parseEventData\executionScripts\E06_DAR/eventAlias.xlsx');
opts.xref_export      = fullfile(pwd, 'dataAcquisition/parseEventData/aliasReports/DAR_alias_check.xlsx');
% opts.verbose          = false;
result = smp_discover_aliases('F:\2026/E06_DAR/_TeamData', opts);
...
debug_print_session_field('F:\2026\E06_DAR\_TeamData\04_GVR\Car#19_Matt Payne_GROVERACING-DAT.19.19.19 V2.ld')
%%
problematicFiles = {'F:\2026\E06_DAR\_TeamData\04_GVR\Car#19_Matt Payne_GROVERACING-DAT.19.19.19 V2.ld'}
for i = 1:numel(problematicFiles)
  ...
  if strcmpi(answerTheQuestion, 'Y')
      ...
      pause(0.5)
      ld_set_session_all(problematicFiles{i}, 'Race 17');
...
%
% Usage:
%   debug_print_session_field('E:\2026\E06_DAR\_TeamData\01_T8R\<file>.ld')
