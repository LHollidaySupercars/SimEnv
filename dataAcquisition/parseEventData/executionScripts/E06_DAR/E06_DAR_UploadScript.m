%% =========================================================
%  E06_DAR_PlottingScript
%  Event-wide upload pass — run ONCE per event, independent of the
%  per-session E06_R19_DAR_PlottingScript. Does not touch that script's
...
%% ---- PATHS ----
TOP_LEVEL_DIR     = 'F:\2026\E06_DAR\COM';
...
RH_PATCH_FILE     = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E06_DAR', 'E06_DAR_Constants.xlsx');
COM_DIR           = 'F:\2026\E06_DAR\COM';
...
fprintf('\n=== E06_DAR_PlottingScript (upload) complete: %.1f min ===\n', toc(t_script)/60);
