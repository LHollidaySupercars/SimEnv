...
SESSION   = 'R17';   % session to process (used in all phases)
...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E06_DAR', 'E06_DAR_Constants.xlsx');
CHANNELS_FILE          = fullfile( pwd, 'dataAcquisition\Motec_MP\channels\channels.xlsx');

% =========================================================================
%  EVENT CONFIG  — edit when setting up a new event
% =========================================================================
cfg.root_folder  = 'F:\2026\E06_DAR';   % event root — all paths derived from here
cfg.hol_venue    = 'DAR';
cfg.hol_event    = 'E06_DAR';
cfg.event_date   = '2026-06-19';   % auto-filled from sessionDate.xlsx (this session's date) — used by Phase 1 (TeamData date filter) and Phase 4b (L180 sort)
...
com_path{1}  = 'E:\2026\E06_DAR\_HOL\teamData\R17\01_T8R\FEE_2026_R17_combined_l180.ld';
com_path{2}  = 'E:\2026\E06_DAR\_HOL\teamData\R17\03_WTG\MOS_2026_R17_combined_l180.ld';
com_path{3}  = 'E:\2026\E06_DAR\_HOL\teamData\R17\10_T18\DEP_2026_R17_combined_l180.ld';
com_path{4}  = 'E:\2026\E06_DAR\_HOL\teamData\R17\10_T18\REY_2026_R17_combined_l180.ld';
