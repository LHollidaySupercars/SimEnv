...
cfg.date_from        = datetime(2026, 5, 23);   % auto-filled from sessionDate.xlsx (this session's date)
...
writetable(pit_summary, fullfile(saveLocation, '26VCS_PitStop_TAS_E05_R15.xlsx'))
