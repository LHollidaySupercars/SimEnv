...
% clear opts
opts.date_from        = datetime(2026, 5, 22);   % auto-filled: earliest session date for this event/track

opts.alias_file       = fullfile(pwd, 'dataAcquisition/Motec_MP/alias/driverAlias.xlsx');
opts.event_alias_file = fullfile(pwd, 'dataAcquisition\parseEventData\executionScripts\E05_TAS/eventAlias.xlsx');
opts.xref_export      = fullfile(pwd, 'dataAcquisition/parseEventData/aliasReports/TAS_alias_check.xlsx');
% opts.verbose          = false;
result = smp_discover_aliases('E:\2026/E05_TAS/_TeamData', opts);
...
%
% Usage:
%   debug_print_session_field('E:\2026\E05_TAS\_TeamData\01_T8R\<file>.ld')
