%% =========================================================
%  ENN_XXX_PlottingScript
%  Event-wide upload pass — run ONCE per event, independent of the
%  per-session ENN_RNN_XXX_PlottingScript. Does not touch that script's
...
%% ---- PATHS ----
TOP_LEVEL_DIR     = 'F:\2026\ENN_XXX\COM';
...
RH_PATCH_FILE     = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\ENN_XXX', 'ENN_XXX_Constants.xlsx');
COM_DIR           = 'F:\2026\ENN_XXX\COM';
...
fprintf('\n=== ENN_XXX_PlottingScript (upload) complete: %.1f min ===\n', toc(t_script)/60);
