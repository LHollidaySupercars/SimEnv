...
SESSION   = 'RNN';   % session to process (used in all phases)
...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\ENN_XXX', 'ENN_XXX_Constants.xlsx');
CHANNELS_FILE          = fullfile( pwd, 'dataAcquisition\Motec_MP\channels\channels.xlsx');

% =========================================================================
%  EVENT CONFIG  — edit when setting up a new event
% =========================================================================
cfg.root_folder  = 'E:\2026\ENN_XXX';   % event root — all paths derived from here
cfg.hol_venue    = 'XXX';
cfg.hol_event    = 'ENN_XXX';
cfg.event_date   = SESSIONDATE_STRING;   % auto-filled from sessionDate.xlsx (this session's date) — used by Phase 1 (TeamData date filter) and Phase 4b (L180 sort)
...
com_path{1}  = 'E:\2026\ENN_XXX\_HOL\teamData\RNN\01_T8R\FEE_2026_RNN_combined_l180.ld';
com_path{2}  = 'E:\2026\ENN_XXX\_HOL\teamData\RNN\03_WTG\MOS_2026_RNN_combined_l180.ld';
com_path{3}  = 'E:\2026\ENN_XXX\_HOL\teamData\RNN\10_T18\DEP_2026_RNN_combined_l180.ld';
com_path{4}  = 'E:\2026\ENN_XXX\_HOL\teamData\RNN\10_T18\REY_2026_RNN_combined_l180.ld';
