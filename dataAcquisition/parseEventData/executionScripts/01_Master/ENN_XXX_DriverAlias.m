...
% clear opts
opts.date_from        = SESSIONDATE_DATETIME;   % auto-filled: earliest session date for this event/track

opts.alias_file       = fullfile(pwd, 'dataAcquisition/Motec_MP/alias/driverAlias.xlsx');
opts.event_alias_file = fullfile(pwd, 'dataAcquisition\parseEventData\executionScripts\ENN_XXX/eventAlias.xlsx');
opts.xref_export      = fullfile(pwd, 'dataAcquisition/parseEventData/aliasReports/XXX_alias_check.xlsx');
% opts.verbose          = false;
result = smp_discover_aliases('E:\2026/ENN_XXX/_TeamData', opts);
...
%
% Usage:
%   debug_print_session_field('E:\2026\ENN_XXX\_TeamData\01_T8R\<file>.ld')
