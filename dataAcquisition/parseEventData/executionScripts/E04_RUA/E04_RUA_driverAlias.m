...
% clear opts
opts.date_from        = datetime(2026, 4, 17);   % auto-filled: earliest session date for this event/track

opts.alias_file       = fullfile(pwd, 'dataAcquisition/Motec_MP/alias/driverAlias.xlsx');
opts.event_alias_file = fullfile(pwd, 'dataAcquisition\parseEventData\executionScripts\E04_RUA/eventAlias.xlsx');
opts.xref_export      = fullfile(pwd, 'dataAcquisition/parseEventData/aliasReports/RUA_alias_check.xlsx');
% opts.verbose          = false;
result = smp_discover_aliases('E:\2026/E04_RUA/_TeamData', opts);
...
%
% Usage:
%   debug_print_session_field('E:\2026\E04_RUA\_TeamData\01_T8R\<file>.ld')
