...
SESSION   = 'Q11';   % session to process (used in all phases)
...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E04_Q11', 'E04_RUA_Constants.xlsx');
