...
SESSION   = 'R11';   % session to process (used in all phases)
...
cfg.rh_patch_file      = fullfile( pwd, 'dataAcquisition\parseEventData\executionScripts\E04_R11', 'E04_RUA_Constants.xlsx');
