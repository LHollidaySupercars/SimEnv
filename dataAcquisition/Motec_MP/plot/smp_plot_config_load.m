...
%   For timeseries_align: yAxis2 is the alignment channel; yAxis1/3/4 are plotted.
    ...
    col_ltFil = find_col(vn, {'lap_type_filter'});
    ...
    plots = struct('name',{}, 'type',{}, 'math_fn',{}, 'x_axis',{}, ...
                   ...
                   'differentiator',{}, 'use_secondary',{}, 'plot_filter',{}, 'lap_type_filter', {}, 'y_lim', {}, 'x_lim', {}, ...
    ...
    for r = 1:height(T)
        ...
        % plotFilter
        p.lap_type_filter = strtrim(get_str(T, r, col_ltFil));
