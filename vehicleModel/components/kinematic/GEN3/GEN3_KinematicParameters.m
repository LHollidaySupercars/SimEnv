...
vehicle.ford.kinematics.body.CoG = [-29, 10.49, 284]; % Centre of Gravity
...
vehicle.ford.kinematics.rear.damper.fittedLength = 500;
vehicle.ford.kinematics.rear.damper.maxCompression = 40;
vehicle.ford.kinematics.rear.damper.maxDroop = 20;
...
vehicle.ford.kinematics.rear.Pot.pivotPoint = [605.5225, 462.4329, 380.644];
vehicle.ford.kinematics.rear.Pot.armPickup  = [670.0128, 473.7571, 342.7843];
v = vehicle.ford.kinematics.rear.Pot.pivotPoint - [605.3531, 420.7730, 363.6311];
vehicle.ford.kinematics.rear.Pot.shaftAxis  = v ./ norm(v);
clear v
...
vehicle.Chevrolet = vehicle.ford;
...
vehicle.ford.kinematics.front.Pot.pivotPoint = [-1994.9996, 432.1091, 439.4587];
vehicle.ford.kinematics.front.Pot.armPickup  = [-1921, 435.9703, 426.6687];
v = vehicle.ford.kinematics.front.Pot.pivotPoint - [-1995, 394.2666, 415.1082];
vehicle.ford.kinematics.front.Pot.shaftAxis  = v ./ norm(v);
vehicle.ford.kinematics.front.clevis.yOffset = [0, 28, 0];

vehicle.ford.kinematics.front.damper.fittedLength = 500;
vehicle.ford.kinematics.front.damper.maxCompression = 40;
vehicle.ford.kinematics.front.damper.maxDroop = 20;
...
vehicle.ford.sensors.teamData.IMU =[-91.85, 150.75, 25.0];
...
vehicle.Chevrolet.minimumWheelbase = 2745.0; % mm
vehicle.Chevrolet.maximumWheelbase = 2767.5;% mm
vehicle.Chevrolet.maximumTrackWidthFront = 2000; % mm
vehicle.Chevrolet.maximumTrackWidthRear = 2000; % mm
vehicle.Chevrolet.maximumLength = 4876.1;% mm
vehicle.Chevrolet.frontAxleBodyWorkMaximum = 1933.3 + 10;% mm
vehicle.Chevrolet.rearAxleBodyWorkMaximum = 1952.6 + 10;% mm
vehicle.Chevrolet.roofHeight_neg625mm = 1123.3% mm
vehicle.Chevrolet.roofheight_neg224_1mm = 1137.8; % mm
vehicle.Chevrolet.roofheight_pos605mm = 1081.1; % mm
vehicle.Chevrolet.frontBumperLocation = [ -3027.9, 0 , -25.1];% mm
vehicle.Chevrolet.rearBumperLocation = [1848.2, 0, 648.4];% mm
...
vehicle.Chevrolet.bonnetHeight_neg1595 = [0, 0, 801.3]; % + 3, -1mm
vehicle.Chevrolet.bonnetHeight_neg2170 = [0, 0, 743.5]; % + 3, -1mm
vehicle.Chevrolet.bonnetHeight_neg2425 = [0, 0, 711.4]; % + 3, -1mm
vehicle.Chevrolet.bonnetHeight_neg2740 = [0, 0, 609.1]; % + 3, -1mm
vehicle.Chevrolet.bonnetHeight_neg1397 = [0, 0, 870]; % + 3, -3mm
vehicle.Chevrolet.bonnetHeight_neg1675 = [0, 0, 845.2]; % + 3, -3mm
vehicle.Chevrolet.dashHeight = [0, 0, 796]; %mm
vehicle.Chevrolet.wheelArchLinersFront = true; % boolean
vehicle.Chevrolet.wheelArchLinersRear = true; % boolean

% Lowercase alias so lower(manufacturer) lookups work for all manufacturers
vehicle.chevrolet = vehicle.Chevrolet;
%% ------------------------------------------------------------------------
%  --------------------------Bicycle model calcs---------------------------
%% ------------------------------------------------------------------------
